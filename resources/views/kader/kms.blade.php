                    ...
                    <div class="flex flex-wrap sm:flex-nowrap items-center justify-between gap-4 mb-5">
                        ...
                        <div class="relative w-full sm:w-auto">
                            <button id="dropdown-button"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2 text-black"
                            ...
                            <tbody
                                ...
                                @if ($kmsDataPaginate->count())
                                    @foreach ($kmsDataPaginate as $kms)
                                        @php
                                            $umurBulan = \Carbon\Carbon::parse(
                                                $selectedBayi->tanggal_lahir,
                                            )->diffInMonths(\Carbon\Carbon::parse($kms->tanggal));
                                        @endphp
                                        <tr>
                ...
                <div id="modal-edit"
                    ...
                    <div class="bg-white p-6 rounded-lg w-full sm:w-1/2 md:w-1/3 mx-4">
                        ...
                        <form id="form-edit" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="edit-tinggi_badan" class="block text-sm font-medium">Tinggi Badan
                                    (cm)</label>
                                <input type="text" name="tinggi_badan" id="edit-tinggi_badan"
                                    class="block w-full px-3 py-2 border rounded-md" required>
                            </div>
                            <div class="mb-4">
                                <label for="edit-berat_badan" class="block text-sm font-medium">Berat Badan
                                    (kg)</label>
