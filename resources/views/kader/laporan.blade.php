<x-layout-kader :selectedKader='$selectedKader'>
    ...
    <div class="container p-5">
        ...
        <form action="{{ route('laporan.index') }}" method="GET">
            ...
            <div
                ...
                <div class="w-full md:w-auto flex justify-start">
                    @if (request('tanggal'))
                        <h3 class="text-xl font-semibold text-gray-900">Kegiatan: <span
                                class="text-blue-600">{{ $namaKegiatan }}</span></h3>
                    @else
                        <h3 class="text-xl font-semibold text-gray-900">Kegiatan: <span class="text-gray-500">Belum ada
                                kegiatan</span></h3>
                    @endif
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white w-full border shadow-md rounded-lg p-6">
            @if (!request('tanggal'))
                <div
                    class="flex items-center justify-center col-span-1 md:col-span-2 bg-yellow-100 text-yellow-800 p-6 rounded-lg shadow-md">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mr-4" fill="none" stroke="currentColor"
                    ...
                    <div class="space-y-2">
                        ...
                        <ul class="pl-1">
                            <li class="flex flex-wrap items-center">
                                ...
                                <div class="w-1/2 text-left">: {{ $jumlahBayiUsia1P }} P, {{ $jumlahBayiUsia1L }} L
                                </div>
                            </li>

                            <li class="flex flex-wrap items-center">
                                <div class="w-1/2 font-medium">Usia 13-60 Bulan</div>
                                <div class="w-1/2 text-left">: {{ $jumlahBayiUsia2P }} P, {{ $jumlahBayiUsia2L }} L
                                </div>
                            </li>
                        </ul>
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="w-1/2">: {{ $balitaMemilikiKMSPerempuan }} P,
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="w-1/2">: {{ $ditimbang0_23Perempuan + $ditimbang24_59Perempuan }} P,
                                {{ $ditimbang0_23LakiLaki + $ditimbang24_59LakiLaki }} L</div>
                        </div>
                        <ul class="pl-1">
                            <li class="flex flex-wrap items-center">
                                <div class="w-1/2 font-medium">0-23 Bulan yg Ditimbang</div>
                                <div class="w-1/2 text-left">: {{ $ditimbang0_23Perempuan }} P,
                                    {{ $ditimbang0_23LakiLaki }} L</div>
                            </li>
                            <li class="flex flex-wrap items-center">
                                <div class="w-1/2 font-medium">24-59 Bulan yg Ditimbang</div>
                                <div class="w-1/2 text-left">: {{ $ditimbang24_59Perempuan }} P,
                                    {{ $ditimbang24_59LakiLaki }} L</div>
                            </li>
                        </ul>
