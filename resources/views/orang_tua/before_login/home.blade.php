          ...
          <div class="rounded-xl shadow-lg bg-[#f3f3f3] w-full max-w-sm mx-auto">
              <div class="p-5 flex flex-col">
                  <div class="rounded-xl overflow-hidden">
                      <img src="{{ asset($item->foto) }}" alt="Gambar" class="w-full h-64 object-cover rounded-t-xl">
                  </div>
                  <h5 class="text-2xl md:text-3xl font-poppins mt-3 font-semibold">{{ $item->nama_kegiatan }}</h5>
                  <p class="text-[#35353580] text-lg mt-2">{{ $item->deskripsi }}</p>
