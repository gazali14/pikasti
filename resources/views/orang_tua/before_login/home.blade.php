...
<div>
  ...
  <div class="container px-5 py-5">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 p-5">
        ...
        <div class="rounded-xl shadow-lg bg-[#f3f3f3] w-full max-w-sm mx-auto">
            <div class="p-5 flex flex-col">
                <div class="rounded-xl overflow-hidden">
                    <img src="{{ asset($item->foto) }}" alt="Gambar" class="w-full h-full object-cover rounded-t-xl">
                </div>
                <h5 class="text-2xl sm:text-xl md:text-3xl font-poppins mt-3 font-semibold truncate">{{ $item->nama_kegiatan }}</h5>
                <p class="text-[#35353580] text-lg sm:text-sm md:text-base mt-2 truncate">{{ $item->deskripsi }}</p>
      ...
      @empty
          <p class="text-center text-gray-500">Belum ada dokumentasi yang tersedia.</p>
      @endforelse
