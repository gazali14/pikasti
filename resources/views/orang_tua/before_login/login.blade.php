...
<body>
    ...
    <div class="absolute top-4 left-4">
        <a href="/" class="flex items-center text-white hover:text-[#62BCB1] transition-colors">
            ...
            <span class="font-lg">Kembali</span>
        </a>
    </div>
                ...
                <form action="{{ route('login-proses') }}" method="POST" class="mt-8">
                    ...
                    <div class="mt-4 relative">
                        ...
                        <span id="togglePassword"
                            class="absolute right-4 top-[55%] transform -translate-y cursor-pointer">
                    ...
                    <div class="mt-4 flex flex-col gap-y-4">
                        <button type="submit"
                            class="active:scale-[.98] active:duration-75 hover:sclae-[1.01] ease-in-out transition-all py-2 rounded-3xl w-full bg-[#62BCB1] text-white text-lg font-bold">Login</button>
                    </div>
                </form>
            </div>
        </div>
