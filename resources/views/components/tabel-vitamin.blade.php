        ...
        <div class=" rounded shadow-sm overflow-x-auto">
            <table id="TableVitamin" class="min-w-full border-collapse border border-[#62BCB1] ">
                ...
                <tbody
                    ...
                    <!-- Contoh Data -->
                    <tr class="border-b vitamin-row" data-id="1">
                        <td
                    ...
                    <tr class="border-b vitamin-row" data-id="2">
                        <td
                            class="text-sm text-gray-900 font-light border-collapse border border-[#62BCB1] px-6 py-4 text-center">
                            Jane Smith
                        </td>
    ...
    <script>
        ...
        document.getElementById('editBtn').addEventListener('click', function() {
            if (selectedRow) {
                ...
                alert('Edit tabel Vitamin ID: ' + kaderId); // Ganti dengan logika edit yang sesuai
            }
        });
        ...
        document.getElementById('deleteBtn').addEventListener('click', function() {
            if (selectedRow) {
                const kaderId = selectedRow.getAttribute('data-id');
                const confirmDelete = confirm('Apakah Anda yakin ingin menghapus tabel vitamin ID ' + kaderId + '?');
                if (confirmDelete) {
