...
<body>
    ...
    <div class="container mx-auto mt-5 mb-10 px-10">
        ...
        <div class=" rounded shadow-sm overflow-x-auto">
            <table id="TableKonsultasi" class="min-w-full border-collapse border border-[#62BCB1] ">
                <thead>
                    <tr>
                ...
                <tbody
                    ...
                    <tr class="border-b konsultasi-row" data-id="2">
                        <td
                            class="text-sm text-gray-900 font-light border-collapse border border-[#62BCB1] px-6 py-4 text-center">
                            <input type="date" id="search-date" class="p-2 border-collapse border border-[#62BCB1] rounded-lg">
                        </td>
    ...
    <script>
        ...
        const rows = document.querySelectorAll('.konsultasi-row');
        ...
        document.getElementById('editBtn').addEventListener('click', function() {
            if (selectedRow) {
                ...
                alert('Edit konsultasi ID: ' + kaderId); // Ganti dengan logika edit yang sesuai
            }
        });
        ...
        document.getElementById('deleteBtn').addEventListener('click', function() {
            if (selectedRow) {
                const konsulId = selectedRow.getAttribute('data-id');
                const confirmDelete = confirm('Apakah Anda yakin ingin menghapus tabel konsultasi ID ' + konsulId + '?');
                if (confirmDelete) {
                    alert('Tabel konsultasi ID ' + konsulId + ' dihapus'); // Ganti dengan logika hapus yang sesuai
                }
            }
        });
        ...
        document.addEventListener('click', function(event) {
            ...
            if (!event.target.closest('#TableKonsultasi')) {
